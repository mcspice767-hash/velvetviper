...
export default function HeatingPage() {
  ...
  const products: Product[] = [
    {
      id: "1",
      name: "UVB 10.0 Bulb (26W)",
      category: "UVB Lighting",
      price: 34.99,
      image: "💡",
      description: "High-output UVB for desert species",
      specs: "10% UVA/UVB, 26W T8"
    },
    {
      id: "2",
      name: "UVB 5.0 Bulb (26W)",
      category: "UVB Lighting",
      price: 24.99,
      image: "🔦",
      description: "Mid-range UVB for tropical species",
      specs: "5% UVA/UVB, 26W T8"
    },
    {
      id: "3",
      name: "UVB LED Panel Pro",
      category: "UVB Lighting",
      price: 89.99,
      image: "📺",
      description: "Full-spectrum LED panel for enclosures",
      specs: "24x12 inches, 30W LED"
    },
    {
      id: "4",
      name: "T8 Light Fixture",
      category: "Fixtures",
      price: 29.99,
      image: "🔧",
      description: "Standard T8 ballast fixture with reflector",
      specs: "Plug & play, dimmable"
    },
    {
      id: "5",
      name: "Ceramic Heat Lamp (150W)",
      category: "Heat Lamps",
      price: 19.99,
      image: "🔥",
      description: "Infrared heat emitter bulb",
      specs: "150W, E27 socket, heat only"
    },
    {
      id: "6",
      name: "Ceramic Heat Lamp (250W)",
      category: "Heat Lamps",
      price: 24.99,
      image: "🌡️",
      description: "High-output ceramic heat bulb",
      specs: "250W, E27 socket, heat only"
    },
    {
      id: "7",
      name: "Heat Mat 40W (40x30cm)",
      category: "Under-Tank Heaters",
      price: 39.99,
      image: "🟫",
      description: "Under-tank heating mat with thermostat",
      specs: "40W, waterproof, adhesive backing"
    },
    {
      id: "8",
      name: "Heat Mat 100W (90x30cm)",
      category: "Under-Tank Heaters",
      price: 69.99,
      image: "🟪",
      description: "Large-area heating mat for terrariums",
      specs: "100W, 90x30cm, thermostat included"
    },
    {
      id: "9",
      ...
      price: 44.99,
      image: "🌡️",
      description: "Precise temperature control and monitoring",
      specs: "50-108°F range, plug-in controller"
    },
    {
      id: "10",
      ...
      specs: "-50 to 400°F, fast reading"
    },
    {
      id: "11",
      name: "Daylight Basking Bulb (75W)",
      category: "Basking Lights",
      price: 12.99,
      image: "☀️",
      description: "Bright white basking light",
      specs: "75W, high color rendering"
    },
    {
      id: "12",
      name: "Complete Lighting Kit",
      category: "Kits",
      price: 129.99,
      image: "📦",
      description: "Full UVB + basking + heat solution",
      specs: "Includes fixtures, bulbs, thermostat"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#e8e0d0] font-serif">
      ...
      <div className="max-w-5xl mx-auto text-center pt-28 pb-16 px-4 md:px-6">
        ...
        <p className="text-xl text-gray-400">UVB bulbs, heat lamps, thermostats & more for optimal reptile health</p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 mb-12">
        <input
          type="text"
          placeholder="Search heating, lighting, thermostats..."
          value={search}
