...
export default function HealthPage() {
  ...
  const products: Product[] = [
    {
      id: "1",
      name: "Calcium Powder (100g)",
      category: "Supplements",
      price: 12.99,
      image: "🧪",
      description: "Pure calcium supplement for bone health",
      specs: "No phosphorus, no D3"
    },
    {
      id: "2",
      name: "Calcium + D3 Powder (100g)",
      category: "Supplements",
      price: 14.99,
      image: "💊",
      description: "Calcium with vitamin D3 for absorption",
      specs: "3:1 ratio, promotes absorption"
    },
    {
      id: "3",
      name: "Multivitamin Powder (100g)",
      category: "Vitamins",
      price: 16.99,
      image: "🌈",
      description: "Complete vitamin & mineral complex",
      specs: "All essential nutrients, reptile formulated"
    },
    {
      id: "4",
      ...
      price: 11.99,
      image: "🥕",
      description: "Vitamin A for vision and immunity",
      specs: "10,000 IU per dose"
    },
    {
      id: "5",
      ...
      price: 18.99,
      image: "🦠",
      description: "Promotes healthy digestive system",
      specs: "Beneficial bacteria culture"
    },
    {
      id: "6",
      ...
      price: 8.99,
      image: "💧",
      description: "Fine mist for humidity control",
      specs: "500ml, adjustable nozzle"
    },
    {
      id: "7",
      name: "Skin Shed Aid (50ml)",
      category: "Skin Care",
      price: 13.99,
      image: "🧴",
      description: "Helps with healthy shedding",
      specs: "Natural oils, promotes clean sheds"
    },
    {
      id: "8",
      ...
      price: 22.99,
      image: "🛡️",
      description: "Safe natural parasite control",
      specs: "Effective, gentle formula"
    },
    {
      id: "9",
      name: "Scale & Shell Cleaner",
      category: "Cleaning",
      price: 9.99,
      image: "🧹",
      description: "Gentle cleaner for scales and shells",
      specs: "Non-toxic, water-safe"
    },
    {
      id: "10",
      name: "Wound Care Spray (50ml)",
      category: "First Aid",
      price: 14.99,
      image: "🩹",
      description: "Anti-bacterial protection for minor wounds",
      specs: "Reptile safe, promotes healing"
    },
    {
      id: "11",
      name: "Hydration Boost Gel",
      category: "Hydration",
      price: 10.99,
      image: "🌊",
      description: "Electrolyte supplement for dehydration",
      specs: "Pre-mixed, ready to use"
    },
    {
      id: "12",
      name: "Complete Health Kit",
      category: "Kits",
      price: 89.99,
      image: "📦",
      description: "All essential supplements and care products",
      specs: "Calcium, vitamins, probiotics, and more"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#e8e0d0] font-serif">
      ...
      <div className="max-w-5xl mx-auto text-center pt-28 pb-16 px-4 md:px-6">
        ...
        <p className="text-xl text-gray-400">Supplements, vitamins & care products for optimal reptile wellness</p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 mb-12">
        <input
          type="text"
          placeholder="Search supplements, vitamins, care products..."
          value={search}
