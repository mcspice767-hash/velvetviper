  ...
  const products: Product[] = [
    {
      ...
      category: "Glass Tanks",
      price: 89.99,
      image: "🏢",
      description: "Premium glass aquarium for snakes and larger reptiles",
      specs: "36x18x18 inches"
    },
    {
      id: "2",
      ...
      price: 49.99,
      image: "📦",
      description: "Ideal for ball pythons and corn snakes",
      specs: "30x12x12 inches"
    },
    {
      id: "3",
      ...
      price: 34.99,
      image: "🏠",
      description: "Perfect for bearded dragons and leopard geckos",
      specs: "20x10x10 inches"
    },
    {
      id: "4",
      name: "PVC Enclosure Large",
      category: "PVC Enclosures",
      price: 199.99,
      image: "🎁",
      description: "Lightweight PVC with secure locking system",
      specs: "48x24x24 inches"
    },
    {
      id: "5",
      name: "PVC Enclosure Medium",
      category: "PVC Enclosures",
      price: 149.99,
      image: "📫",
      description: "Ideal for ball pythons and medium snakes",
      specs: "36x18x18 inches"
    },
    {
      id: "6",
      name: "Bioactive Vivarium Kit",
      category: "Specialized",
      price: 249.99,
      image: "🌿",
      description: "Complete bioactive setup with substrate and drainage",
      specs: "Includes substrate, plants, clean-up crew"
    },
    {
      id: "7",
      name: "Arboreal Enclosure",
      category: "Specialized",
      price: 169.99,
      image: "🌳",
      description: "Tall enclosure for tree-dwelling reptiles",
      specs: "24x24x36 inches"
    },
    {
      id: "8",
      name: "Breeder Rack System",
      category: "Rack Systems",
      price: 299.99,
      image: "📚",
      description: "Stackable breeding racks with 6 compartments",
      specs: "Professional grade, temperature management"
    },
    {
      id: "9",
      name: "Hides & Caves (3-pack)",
      category: "Accessories",
      price: 29.99,
      image: "🏔️",
      description: "Assorted natural hides for security",
      specs: "Small, medium, large sizes"
    },
    {
      id: "10",
      name: "Climbing Structure Wood",
      category: "Accessories",
      price: 34.99,
      image: "🪵",
      description: "Natural wood branches for climbing",
      specs: "Sterilized and safe"
    },
    {
      id: "11",
      name: "Substrate Mix (20qt)",
      category: "Substrate",
      price: 24.99,
      image: "🌱",
      description: "Premium reptile bedding blend",
      specs: "Aspen, coconut, cypress mix"
    },
    {
      id: "12",
      name: "Paper Bedding (50lbs)",
      category: "Substrate",
      price: 19.99,
      image: "📄",
      description: "Eco-friendly paper bedding",
      specs: "Dust-free, safe for all reptiles"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#e8e0d0] font-serif">
      ...
      <div className="max-w-5xl mx-auto text-center pt-28 pb-16 px-4 md:px-6">
        ...
        <p className="text-xl text-gray-400">Premium terrariums, tanks & vivariums for your reptile</p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 mb-12">
        <input
          type="text"
          placeholder="Search tanks, enclosures, hides..."
          value={search}
